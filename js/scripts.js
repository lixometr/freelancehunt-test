(()=>{var __webpack_modules__={206:(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{"use strict";eval(`
...
function closestElement(selector, base) {
  ...
  function __closestFrom(el) {
    if (!el || el === getDocument() || el === ssr_window_esm_getWindow())
      return null;
    if (el.assignedSlot)
      el = el.assignedSlot;
...
/* harmony default export */ const core_breakpoints = ({
...
// EXTERNAL MODULE: ./tailwind-plugins/screens.js
var screens = __webpack_require__(435);
var screens_default = /*#__PURE__*/__webpack_require__.n(screens);
;// CONCATENATED MODULE: ./src/js/breakpoints.js

const breakpoints_breakpoints = {};
Object.keys((screens_default())).map((key) => {
  breakpoints_breakpoints[key] = parseInt((screens_default())[key]);
});
/* harmony default export */ const js_breakpoints = (breakpoints_breakpoints);

;// CONCATENATED MODULE: ./src/js/helpers.js

const bpLess = (bp) => {
  return window.matchMedia(\`(max-width: \${js_breakpoints[bp] - 1}px)\`).matches;
};
const bpMore = (bp) => {
...
(function() {
  ...
  const checkSlider = () => {
    if (bpLess("md")) {
      if (slider)
        return;
      slider = new core_class(".clients-slider", {
        slidesPerView: "auto",
        spaceBetween: 27,
        breakpoints: {
          [js_breakpoints.xs]: {
...
new core_class(".for-orders-slider", {
  threshold: 5,
  slidesPerView: 1.3,
  spaceBetween: 20,
  pagination: {
...
;// CONCATENATED MODULE: ./src/js/event.js
const eventMixin = {
...
;// CONCATENATED MODULE: ./src/js/useStopScroll.js
/* harmony default export */ const useStopScroll = (() => {
...
class HeaderMenu {
  ...
  updateIndex(idx) {
    if (this.activeIdx === idx)
      return;
    this.activeIdx = idx;
    this.triggers.forEach((trigger2) => trigger2.classList.remove("open"));
...
class Menu {
  constructor(menu, overlay, trigger, options) {
    ...
    this.overlay = typeof overlay === "string" ? document.querySelector(overlay) : overlay;
...
;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/utils/Numbers.js
var Numbers;
(function(Numbers2) {
  Numbers2.parseOrElse = function(str, or) {
    if (or === void 0) {
      or = "0";
    }
    if (str) {
...
;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/utils/Element.js
...
(function(Element2) {
  ...
  Element2.setStyles = function(element, styles) {
    Object.keys(styles).map(function(key) {
      element.style[key] = styles[key];
    });
  };
  Element2.getBoxStyles = function(element) {
  ...
  Element2.getElement = function(element) {
  ...
  Element2.setAttribute = function(element, attribute, value) {
    element.setAttribute(attribute, value);
  };
  Element2.getAttribute = function(element, attribute) {
    return element.getAttribute(attribute);
  };
})(Element_Element || (Element_Element = {}));

;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/utils/Event.js
var Events;
(function(Events2) {
  Events2.on = function(element, event, callback) {
    element.addEventListener(event, callback);
    return {
      destroy: function() {
        return element && element.removeEventListener(event, callback);
      }
    };
  };
})(Events || (Events = {}));

;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/utils/Animate.js
...
(function(Animate2) {
  ...
  var getTransition = function(options) {
    var miliseconds = options.miliseconds, transitionFunction = options.transitionFunction;
    return "all " + miliseconds + "ms " + transitionFunction + " 0s";
  };
  var isHidden = function(element) {
    return Element_Element.getAttribute(element, slideToggleAttribute) === "false";
  };
  var isShown = function(element) {
    return Element_Element.getAttribute(element, slideToggleAttribute) === "true";
  };
  Animate2.shouldCollapse = function(element) {
    var attribute = Element_Element.getAttribute(element, slideToggleAttribute);
    if (!attribute) {
      var height = Element_Element.getBoxStyles(element).height;
      return height && height > 0;
    }
    return Element_Element.getAttribute(element, slideToggleAttribute) === "true";
  };
  Animate2.hide = function(element, options) {
    if (isHidden(element)) {
      return;
    }
    var _a = Element_Element.getBoxStyles(element), height = _a.height, boxStyles = __rest(_a, ["height"]);
    Element_Element.setStyles(element, { transition: "" });
    onRequestAnimationFrame(function() {
      Element_Element.setStyles(element, {
        overflow: "hidden",
        height: height + "px",
    ...
    Element_Element.setAttribute(element, slideToggleAttribute, "false");
  };
  Animate2.show = function(element, options) {
    if (isShown(element)) {
      return;
    }
    Element_Element.setStyles(element, {
    ...
    onRequestAnimationFrame(function() {
      ...
      onRequestAnimationFrame(function() {
        ...
        var event = Events.on(element, "transitionend", function() {
          Element_Element.setStyles(element, { height: "" });
          event.destroy();
        });
      });
    });
    Element_Element.setAttribute(element, slideToggleAttribute, "true");
  };
})(Animate || (Animate = {}));

;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/utils/index.js



;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/common/hide.js

var Hide;
(function(Hide2) {
  Hide2.on = function(element, options) {
    Animate.hide(element, options);
  };
})(Hide || (Hide = {}));
var hide_hide = function(element, options) {
  Hide.on(Element_Element.getElement(element), options);
};

;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/common/show.js

var Show;
(function(Show2) {
  Show2.on = function(element, options) {
    Animate.show(element, options);
  };
})(Show || (Show = {}));
var show_show = function(element, options) {
  Show.on(Element_Element.getElement(element), options);
};

;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/common/toggle.js

var Toggle;
(function(Toggle2) {
  Toggle2.on = function(element, options) {
...
;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/common/index.js




;// CONCATENATED MODULE: ./node_modules/slidetoggle/dist/index.js
...
;// CONCATENATED MODULE: ./src/js/tabs-categories.js
...
class TabsCategories {
  ...
  getActiveContent() {
    return this.contents.find((block) => block.getAttribute("data-index") === String(this.activeIdx));
  }
  selectItem(index) {
    if (this.isAnimating)
      return;
  ...
  updateCategories() {
    ...
    const newCategory = this.categories.find((cat) => cat.getAttribute("data-index") === String(this.activeIdx));
    newCategory.classList.add("active");
  }
  updateContent(prevIdx) {
    return __async(this, null, function* () {
      const prevBlock = this.contents.find((block) => block.getAttribute("data-index") === String(prevIdx));
  ...
  checkSlider() {
    if (bpLess("md")) {
      if (this.categoriesSlider)
        return;
      const swiperContainer = this.categoryBlock.querySelector(".swiper-container");
      const arrowRight = this.categoryBlock.querySelector(".categories-tabs-categories__arrow");
      this.categoriesSlider = new core_class(swiperContainer, {
        slidesPerView: "auto",
        navigation: {
          nextEl: arrowRight
        },
...
//# sourceURL=webpack://freelancehunt/./src/js/scripts.js_+_93_modules?`)},435:module=>{eval(`module.exports = {
  xxs: "350px",
  xs: "550px",
  sm: "768px",
  md: "992px",
...
//# sourceURL=webpack://freelancehunt/./tailwind-plugins/screens.js?`)}},__webpack_module_cache__={};function __webpack_require__(e){var n=__webpack_module_cache__[e];if(n!==void 0)return n.exports;var s=__webpack_module_cache__[e]={exports:{}};return __webpack_modules__[e](s,s.exports,__webpack_require__),s.exports}(()=>{__webpack_require__.n=e=>{var n=e&&e.__esModule?()=>e.default:()=>e;return __webpack_require__.d(n,{a:n}),n}})(),(()=>{__webpack_require__.d=(e,n)=>{for(var s in n)__webpack_require__.o(n,s)&&!__webpack_require__.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:n[s]})}})(),(()=>{__webpack_require__.o=(e,n)=>Object.prototype.hasOwnProperty.call(e,n)})();var __webpack_exports__=__webpack_require__(206)})();
